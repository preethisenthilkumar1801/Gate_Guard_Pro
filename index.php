...
<head>
    ...
    <style>
        body {
            background-image: url("./kctpic.jpeg");
...
<body>
    ...
    <header>
        ...
        <div class="logo">
            <span class="blue">K</span>umaraguru<span class="blue"> C</span>ollege of <span class="blue">
                T</span>echnology</span>
        </div>
    ...
    <main>
        ...
        <p class="quote">CHARACTER IS LIFE!</p>
    ...
    <footer>
        <div class="footer-content">
            <p>&copy; KCT GATEPASS APPROVAL SYSTEM</p>
        </div>
    </footer>
