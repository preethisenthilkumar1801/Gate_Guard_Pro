    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a style="color:#DAA520;" href="AddEmployee.php"><i class="fas fa-plus"></i> Add Student</a>
                </li>
				<li>
                    ...
                    <div class="col-lg-12">
						...
						<?php
							...
							if (isset($_SESSION['msgForEmpCreate']))
							{
								...
								{												
									...
									?>
									<h3 align="center">Student Added Successfully</h3>
						...
						<form role="form" action="../controller/AddEmployeeController.php" method="post" >
							...
							<div class="form-group">
								...
								<label for="empDptName"> Department: </label>
								<?php
							...
							<div class="form-group">
								...
								<label for="empDesiName">Designation: </label>
								<?php
							...
							<div class="form-group">
								...
								<label for="empCodeNum">Roll No: </label>
								<input type="text" class="form-control" placeholder="Roll No" name="empCodeNum" id="empCodeNum">
							...
							<div class="form-group">
								...
								<input type="email" class="form-control" placeholder="Email Address ...." name="empEmailAddress" id="empEmailAddress" >
							
							</div>
							
							<div class="form-group">
						
								<label for="empLoginPass">Login Password: </label>
								<input type="password" class="form-control" placeholder="Login Password ...." name="empLoginPass" id="empLoginPass" >
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="First Name ...." name="empFirstName" id="empFirstName" >
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Last Name ...." name="empLastName" id="empLastName" >
							...
							<div class="form-group">
								...
								<input type="date" class="form-control" placeholder="Date Of Birth ...." name="empDoB" id="empDoB" >
							...
							<div class="form-group">
								...
								<label for="empPhoneNumPersonal">Student contact number: </label>
								<input type="text" class="form-control" placeholder="Student contact number" name="empPhoneNumPersonal" id="empPhoneNumPersonal" >
							
							</div>
							
							<div class="form-group">
						
								<label for="empPhoneNumOffice">Parent contact number: </label>
								<input type="text" class="form-control" placeholder="Parent contact number" name="empPhoneNumOffice" id="empPhoneNumOffice" >
							
							</div>
							
							<div class="form-group">
						
								<label for="empParmanentAddress">Permanent Address: </label>
								<input type="text" class="form-control" placeholder="Permanent Address ...." name="empParmanentAddress" id="empParmanentAddress" >
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Present Address ...." name="empPresentAddress" id="empPresentAddress" >
							
							</div>
						
							<button type="submit" name="btnSubmit" class="btn btn-success">Add Student</button>
