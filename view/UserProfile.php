...
?>
    ...
    <link rel="stylesheet" href="styles.css">
		...
		<!-- <header>
			<div style="background-color:#0a4c5d";>
			<p style="font-size:50px";>Gatepass Approval Portal</p>
        ...
        <div style="margin-left:70%;">
            <span class="blue">K</span>umaraguru<span class="blue"> C</span>ollege of <span class="blue"> T</span>echnology</span>
				...
				<div id="sidebar-wrapper" >
					<ul class="sidebar-nav">
						<li class="sidebar-brand" >
							<a href="LeaveApplication.php"><i class="fas fa-plus"></i>Outpass</a>
						</li>
						<li>
						...
						<li>
							<a href="AddEmployee.php"><i class="fas fa-plus"></i> Add Students</a>
						</li>
						<li>
							<a href="ListEmployee.php"><i class="fas fa-stream"></i> List Students</a>
						</li>
						<li>
							<a href="UsersLeaveDetails.php"><i class="fas fa-clipboard-list"></i>Leave Details</a>
						</li>
						<!-- <li>
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<form class="form-group" role="form" action="../controller/UserController.php" method="post">
									...
									{
										echo "<br/><span style='color:#DAA520;' class='glyphicon glyphicon-road'></span> Your are approved from <b style='color:#DAA520;'>".$historyForLeave['lLeaveFromDate']."</b> To <b style='color:#DAA520;'>".$historyForLeave['lLeaveToDate']."</b>. Total <b style='color:#DAA520;'>".$historyForLeave['lTotalLeaveDays']."</b> Days.<br/>";
									}  		
								...
								<form class="col-md-6 form-horizontal" role="form" action="" method="" >
									...
									<div class="form-group col-md-12">
										...
										<label class="col-sm-6 control-label" for="userName">Admin Name: </label>
										<div class="col-sm-6">
											<p class="form-control-static"><?php echo $rowForUser['eFirstName']." ".$rowForUser['eLastName']; ?></p>
										</div>
										
										<label class="col-sm-6 control-label" for="userOfficeCode">Roll No: </label>
										<div class="col-sm-6">
											<p class="form-control-static"><?php echo $rowForUser['eEmployeeCodeNumber']; ?></p>
										</div>
										
										<label class="col-sm-6 control-label" for="userDpt">Department: </label>
										<div class="col-sm-6">
											<p class="form-control-static"><?php echo $rowForUser['dptName']; ?></p>
										</div>
										
										<!-- <label class="col-sm-6 control-label" for="userDesi">Batch: </label>
										<div class="col-sm-6">
											<p class="form-control-static"><?php echo $rowForUser['desiDesignationName']; ?></p>
										</div> -->
										
										<label class="col-sm-6 control-label" for="userDoB"> DoB: </label>
										<div class="col-sm-6">
											<p class="form-control-static"><?php echo $rowForUser['eDateOfBirth']; ?></p>
										</div>
										
										<label class="col-sm-6 control-label" for="userGender"> Gender: </label>
										<div class="col-sm-6">
											<p class="form-control-static"><?php echo $rowForUser['eGender']; ?></p>
										</div>
										
										<label class="col-sm-6 control-label" for="userBlood">Parent Contact Number: </label>
										<div class="col-sm-6">
											<p class="form-control-static"><?php echo $rowForUser['bName']; ?></p>
										</div>
										
										<label class="col-sm-6 control-label" for="userEmail">Email Address: </label>
										<div class="col-sm-6">
										...
										<label class="col-sm-6 control-label" for="userPermanentAddress">Permanent Address: </label>
										<div class="col-sm-6">
										...
										if(isset($_SESSION['UserInfoUpdated']))
										{
											if($_SESSION['UserInfoUpdated'] == 1)
											{
												...
												<div class="form-group">
													...
													<label class="col-sm-6 control-label" for="userPersonalPhoneNumber"> Phone Number: </label>
													<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<label class="col-sm-6 control-label" for="userPresentAddress">Present Address: </label>
													<div class="col-sm-6">
												...
												<div class="form-group">
													...
													<label class="col-sm-6 control-label" for="userPassword"> Password: </label>
													<div class="col-sm-6">
		...
		<body>
			...
			<div id="wrapper">
				...
				<div id="sidebar-wrapper">
					<ul class="sidebar-nav">
						<li class="sidebar-brand">
							<a href="LeaveApplication.php">Outpass</a>
						</li>
						<li>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-12">
								...
								<a href="#menu-toggle" class="btn btn-primary" id="menu-toggle"><i class="fas fa-exchange-alt"></i> Menu Bar</a>
								<h1 align="center">Students Profile</h1>
								...
								<form class="form-group" role="form" action="../controller/UserController.php" method="post">
									...
									// if(!mysqli_fetch_array($livHistory)) echo "you were rejected";
									// while($historyForLeave = mysqli_fetch_array($livHistory))
									// {
									// 	echo "<br/><span style='color:#DAA520;' class='glyphicon glyphicon-road'></span> You were approved <b style='color:#DAA520;'>".$historyForLeave['lLeaveFromDate']."</b> To <b style='color:#DAA520;'>".$historyForLeave['lLeaveToDate']."</b>. Total <b style='color:#DAA520;'>".$historyForLeave['lTotalLeaveDays']."</b> Days.<br/>";
									// }
									...
									//  $livHistor = $objLeaveApplication->getHistory();
									//  while($historyForLeave = mysqli_fetch_array($livHistor))
									// {
									//  	echo "<br/><span style='color:#DAA520;' class='glyphicon glyphicon-road'></span> Your are rejected <b style='color:#DAA520;'>";
									// } 
								...
								<form class="col-md-6 form-horizontal" role="form" action="" method="" >
									...
									<div class="form-group col-md-12">
										...
										<label class="col-sm-6 control-label" for="userName">Student Name: </label>
										<div class="col-sm-6">
											<p class="form-control-static"><?php echo $rowForUser['eFirstName']." ".$rowForUser['eLastName']; ?></p>
										</div>
										...
										<label class="col-sm-6 control-label" for="userOfficePhoneNumber">Parent Contact Number: </label>
										<div class="col-sm-6">
											<p class="form-control-static"><?php echo $rowForUser['ePhoneNumberOffice']; ?></p>
										</div>
										...
										if(isset($_SESSION['UserInfoUpdated']))
										{
											if($_SESSION['UserInfoUpdated'] == 1)
											{
												...
												<div class="form-group">
													...
													<label class="col-sm-6 control-label" for="userPersonalPhoneNumber">Student Contact Number:</label>
													<div class="col-sm-6">
														<input type="text" class="form-control" value="<?php echo $rowForUser['ePhoneNumberPersonal']; ?>" name="userPersonalPhoneNumber" id="userPersonalPhoneNumber" required>
													</div>
												...
												<h3 align="center"><button type="submit" name="btnUserInfoUpdate" class="btn btn-primary">Update</button></h3>
												<?php
											}
											else
											{
												...
												<h3 align="center"><button type="submit" name="btnUserInfoUpdate" class="btn btn-info">Update</button></h3>
												<?php
											}
										}
										else
